...
--Store PID in Clients
insert into Clients (PID) values (1);
insert into Clients (PID) values (2);
insert into Clients (PID) values (3);
insert into Clients (PID) values (4);
insert into Clients (PID) values (5);
insert into Clients (PID) values (6);
insert into Clients (PID) values (7);
insert into Clients (PID) values (8);
insert into Clients (PID) values (9);
insert into Clients (PID) values (10);
...
--Insert statements into Classifications Table
insert into Classifications (Title) values ('Landscaper');
insert into Classifications (Title) values ('Technician');
insert into Classifications (Title) values ('Project Manager');
insert into Classifications (Title) values ('Foreman');
insert into Classifications (Title) values ('Office Manager');
insert into Classifications (Title) values ('Office Worker');
...
insert into Employees_Classifications (PID, ClassificationID) values (11, 1);
insert into Employees_Classifications (PID, ClassificationID) values (12, 1);
insert into Employees_Classifications (PID, ClassificationID) values (13, 1);
insert into Employees_Classifications (PID, ClassificationID) values (14, 1);
insert into Employees_Classifications (PID, ClassificationID) values (15, 5);
insert into Employees_Classifications (PID, ClassificationID) values (16, 6);
insert into Employees_Classifications (PID, ClassificationID) values (17, 3);
insert into Employees_Classifications (PID, ClassificationID) values (18, 3);
insert into Employees_Classifications (PID, ClassificationID) values (19, 4);
insert into Employees_Classifications (PID, ClassificationID) values (20, 2);
insert into Employees_Classifications (PID, ClassificationID) values (21, 2);
insert into Employees_Classifications (PID, ClassificationID) values (22, 2);
insert into Employees_Classifications (PID, ClassificationID) values (23, 2);
insert into Employees_Classifications (PID, ClassificationID) values (24, 6);
insert into Employees_Classifications (PID, ClassificationID) values (25, 6);

--Clients_Projects
insert into Clients_Projects (PID, ProjectID) values (1, 1);
insert into Clients_Projects (PID, ProjectID) values (2, 2);
insert into Clients_Projects (PID, ProjectID) values (3, 3);
insert into Clients_Projects (PID, ProjectID) values (4, 4);
insert into Clients_Projects (PID, ProjectID) values (5, 5);
insert into Clients_Projects (PID, ProjectID) values (6, 6);
insert into Clients_Projects (PID, ProjectID) values (7, 7);
insert into Clients_Projects (PID, ProjectID) values (8, 8);
